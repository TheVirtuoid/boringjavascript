const myCat = { "type": "Cat", "name": "Fluffy", "class": "Mammalia"};

const newProperty = Symbol("tail");
myCat[newProperty] = true;

console.log(myCat);

for(const catProperty in myCat) {
	console.log(`The property "${catProperty}" contains the value "${myCat[catProperty]}".`);
}
